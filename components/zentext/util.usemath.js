...
export function zenable({ startingPos, pos }) {
  ...
  // climb
    ...
    var currentPosWithinRange = (1800 - pos); // 1400 = pos
    var differenceInPercentageBetweenTotalDistanceAndCurrentPos = (
      currentPosWithinRange / totalDistanceToRange * 100
    ).toFixed(2);


    return 'climb.' + differenceInPercentageBetweenTotalDistanceAndCurrentPos;
  }
  // descend
  else if (between(pos, {min: 2200, max: 3000})){
    return 'desc.' + percent(3000 - pos, 600)
  }
}
