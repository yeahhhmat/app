...
import { AdminSearch } from "../../adminforms/search";
...
export default function AdminHeader () {
  ...
  return (
    <nav className="bg-white shadow-md border-gray-200 px-6 py-2.5 rounded dark:bg-gray-800">
      <div className="flex flex-wrap justify-between items-center mx-auto my-4">
        <Link href="/">
        ...
        <div className="flex md:order-2 items-center">
          <p className="block mr-4 text-sm">
            <span className="font-medium">{'Role:'}</span>
            <span className="font-mono">&nbsp;{user.username}</span>
          </p>
          <button
            type="button"
            className="flex text-sm shadow hover:shadow-lg hover:bg-blue-100 border rounded focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
            id="user-menu-button"
            aria-expanded="false"
